...
class PumpController(QObject):
    ...
    def __init__(self):
        ...
        self.runtime_sec = 30  # Default fallback
    ...
    def handle_start_sample_window(self, window):
        ...
        try:
            ...
            if self.current_repeat < self.repeat_count and self.base_sample_name:
                ...
                # No more repeats - user needs to handle manually
                self.log(
                    "Start sample window detected - awaiting manual input (no repeats configured)"
                )
...
class LogWindow(QWidget):
    ...
    def toggle_automation(self):
        ...
        if self.automation_on:
            # Lock all controls when automation is running
            ...
            # Unlock all controls when automation is stopped
