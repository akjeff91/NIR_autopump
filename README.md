...
v1.2: added some extra functionality to the sample repeater, including a 90 sec flush in the GUI and sample submission so automation does not have to be stopped to submit a new sample name
